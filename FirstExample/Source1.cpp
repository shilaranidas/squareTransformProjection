...
float scale =1.0f,scale1 = 0.707f, inc = -0.05f, angle = 0.0f;
...
void display(void)
{
	...
	glBindVertexArray(1);
	transformObject(1.0f, Z_AXIS, angle, glm::vec3(0.0f, 0.0f, 0.0f));
	glDrawArrays(GL_LINE_LOOP, 0, 4);
	//scale
	glBindVertexArray(2);
	transformObject(0.707f, Z_AXIS, angle, glm::vec3(0.0f, 0.0f, 0.0f));
	glDrawArrays(GL_LINE_LOOP, 0, 4);

	//translate
	glBindVertexArray(3);
	transformObject(1.0f, Z_AXIS, angle, glm::vec3(0.4f, 0.0f, 0.0f));
	glDrawArrays(GL_LINE_LOOP, 0, 4);

	//rotate
	glBindVertexArray(4);
	transformObject(1.0f, Z_AXIS, 45.0f, glm::vec3(0.4f, 0.0f, 0.0f));
	glDrawArrays(GL_LINE_LOOP, 0, 4);
	//glBindVertexArray(0); // Can optionally unbind the vertex array to avoid modification.
